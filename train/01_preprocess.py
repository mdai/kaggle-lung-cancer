...
if __name__ == '__main__':
    ...
    out_dir = os.path.join(BASEPATH, 'data_proc/stage1/isotropic_volumes_1mm')
    os.makedirs(out_dir, exist_ok=True)
    metadata_filepath = os.path.join(BASEPATH, 'data_proc/stage1/isotropic_volumes_1mm.pkl')
