...
if __name__ == '__main__':
    ...
    data_dir = os.path.join(BASEPATH, 'data_train/stage1/nodule_bbox/patches_1')
    transfer_weights_filepath = os.path.join(BASEPATH, 'weights/stage1/nodule_detect/m02a.hdf5')
